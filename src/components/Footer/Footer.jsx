        ...
        <footer className="bg-[#1c1c1c] text-gray-300 mt-6 py-8">
                ...
                <div className="flex-1 ml-4">
                    ...
                    <ul className="space-y-2">
                        <li className="flex items-center">
                            ...
                            <span>+91 9951234835</span>
                        </li>
                        <li className="flex items-center">
                            <FaEnvelope className="text-yellow-500 mr-2" />
                            <span>hello@formulaq.io</span>
                        </li>
                    </ul>
                </div>
                ...
                <div className="flex-1">
                    ...
                    <ul className="space-y-2">
                        <li className="flex items-start">
                            <MdLocationOn className="text-yellow-500 mr-2" />
                            <span>
                                #57, MIG - II, 7th Phase,<br />
                                KPHB, Hyderabad, Telangana - 500085, India.
                            </span>
                        </li>
                    </ul>
                </div>
            ...
            <div className="container mx-auto px-4 mt-8 flex flex-col md:flex-row justify-between items-center border-t border-gray-700 pt-4">
                ...
                <div className="flex space-x-4 text-gray-400">
                    <a href="https://www.linkedin.com/company/formulaq-solutions/mycompany/" target="_blank" rel="noopener noreferrer">
